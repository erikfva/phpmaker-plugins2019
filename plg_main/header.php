...
if(!empty($Page) && $Page->TableName == "main.php"){
	AddStylesheet($plgConf["plugins_path"]."plg_main/metro/jquery.metro.css");
	AddStylesheet($plgConf["plugins_path"]."plg_main/main.css");
	global $customstyle;
...
AddClientScript($plgConf["plugins_path"]."plg_main/userfn.js");

if (IsLoggedIn()){
	if (empty(CurrentPage()->Export) && !IsMobile()) {
		//Mensaje deslizable cargando...
		AddStylesheet($plgConf["plugins_path"]."plg_main/loading/css/loading.css");
		echo '
